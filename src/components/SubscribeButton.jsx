...
function SubscribeButton() {
  return (
    <div className="subscribe-buttons">
      <a
        href="https://open.spotify.com/show/4VY57mUtnr7fqRtmN2j9Ra"
        target="_blank"
        rel="noopener noreferrer"
        className="subscribe-button subscribe-button--spotify"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="subscribe-button subscribe-button--apple"
