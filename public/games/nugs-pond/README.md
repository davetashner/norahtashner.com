...
| **Pond Race** | Fluency. The child picks a racer from nine characters (Nug, Bun Bun, Miso, Waffles, Bao, Waddles, Maple, Sparkle and Oscar), then types answers on a big number pad and taps **Enter** to check (a keyboard's Enter key works too). This lets them paddle past Duck. A wrong answer shows a red X and offers **Try again** or **Show me**, and Duck waits meanwhile. Duck's speed adapts after each race so races stay close. |
...
Oscar is a red-breasted hummingbird who lives at the pond. He hovers next to Nug on the home screen, and tapping him makes him chirp and say something friendly. In Lily Hop he darts between the lotus flowers. He can also race Duck in Pond Race.
